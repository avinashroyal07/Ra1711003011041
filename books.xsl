...
<td bgcolor="#8AFF33" style="color:#D9D9D9 "> <b> <xsl:value-of select="author"/> </b> </td>
<td bgcolor="#FFAD18" ><xsl:value-of select="genre"/></td>
<td bgcolor="#33FFE0"><xsl:value-of select="copyright"/></td>
<td bgcolor="#FFAD18"><xsl:value-of select="edition" /></td>
<td bgcolor="#FFAD18"><xsl:value-of select="isbn" /></td>
<td bgcolor="#FF3933"><xsl:value-of select="publisher"/></td>
